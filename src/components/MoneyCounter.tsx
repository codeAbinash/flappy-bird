        ...
        <>
            ...
            <div className="fixed top-4 right-4 z-50">
                <div className="relative">
                    <div className="absolute inset-0 bg-linear-to-r from-yellow-400 to-amber-500 blur-xl opacity-50 animate-pulse"></div>

                    <div className="relative bg-linear-to-br from-gray-900 via-gray-800 to-black border-2 border-yellow-500 rounded-lg px-5 py-2 shadow-2xl">
                        <div className="flex items-center gap-2">
                            <div className="flex flex-col">
                                <span className="text-xl font-black bg-linear-to-r from-yellow-300 via-yellow-400 to-amber-500 bg-clip-text text-transparent drop-shadow-[0_0_10px_rgba(234,179,8,0.5)]">
